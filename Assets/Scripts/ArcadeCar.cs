...
public class ArcadeCar : MonoBehaviour
{
    ...
    void UpdateInput()
    {
        ...
        bool isHandBrakeNow = (Input.GetKey(KeyCode.Space) || Input.GetButton("Fire1")) && controllable;
    ...
    {
        ApplyVisual();
        Radio.volume = 0.12f + rb.velocity.magnitude / 50;
        if(transform.position.y < - 50) 
        {
            Reset(new Vector3(0, 15, 0));
        }
    }
